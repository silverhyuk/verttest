...
public class VertServerWorld implements Runnable{

	private static VertServerWorld instance = null;
	
	public static VertServerWorld getInstance(){
		if(instance == null){
			instance = new VertServerWorld();
